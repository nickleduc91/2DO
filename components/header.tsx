        ...
        <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
          {isSession ? (
            <div className="bg-white dark:bg-slate-800 rounded-full py-3 px-6">
              ...
              <span
                className="cursor-pointer ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-2xl border border-transparent bg-cyan-500 px-4 py-2 text-xl font-medium text-white shadow-sm hover:bg-cyan-700"
                onClick={() => signOut()}
              >
                Sign out
              </span>
