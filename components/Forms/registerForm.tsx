          ...
          <div className="xl:ml-20 xl:w-4/12 lg:w-4/12 md:w-4/12 mb-12 md:mb-0">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="mb-6 grid grid-cols-2 gap-7">
                <input
                  {...register("firstName")}
                  className="text-black dark:text-white bg-white dark:bg-slate-900 border-b-2 border-black dark:border-white ml-4 form-control block w-full px-4 py-2 text-lg bg-clip-padding transition ease-in-out m-0 focus:border-cyan-500 dark:focus:border-cyan-500 focus:outline-none"
